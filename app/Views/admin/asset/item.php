                                            ...
                                            <td>
                                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right shadow" aria-labelledby="userDropdown">
                                                        <!-- Update -->
                                                        <a class="dropdown-item" href="<?= htmlspecialchars($base) ?>/admin/assets/item/edit?inventory_id=<?= $row['inventory_id']; ?>">
                                                            <i class="fas fa-edit fa-sm fa-fw mr-2 text-black-400"></i>
                                                            Update
                                                        </a>
                                                        <!-- View -->
                                                        <a class="dropdown-item" href="<?= htmlspecialchars($base) ?>/admin/assets/transfer?inventory_id=<?= $row['inventory_id']; ?>">
                                                            <i class="fas fa-exchange-alt fa-sm fa-fw mr-2 text-black-400"></i>
                                                            Transfer
                                                        </a>
                                                        <a class="dropdown-item" href="<?= htmlspecialchars($base) ?>/admin/assets/transfer-history?inventory_id=<?= $row['inventory_id']; ?>">
