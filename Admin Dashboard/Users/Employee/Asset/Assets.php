...
if ($stmtasset = mysqli_prepare($link, $fetchAssets)) {
    mysqli_stmt_bind_param($stmtasset, "i", $employee_id);
    if (mysqli_stmt_execute($stmtasset)) {
        $result = mysqli_stmt_get_result($stmtasset);
    } else {
                                                ...
                                                <td>
                                                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                                            <!-- File Ticket -->
                                                            <a class="dropdown-item" href="File-Ticket.php?inventory_id=<?= $row['inventory_id']; ?>">
                                                                <i class="fas fa-edit fa-sm fa-fw mr-2 text-black-400"></i>
                                                                File Ticket
                                                            </a>
                                                            <!-- View -->
                                                            <a class="dropdown-item" href="View-Asset.php?inventory_id=<?= $row['inventory_id']; ?>">
