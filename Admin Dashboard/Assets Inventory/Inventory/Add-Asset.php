...
include("session-checker.php");
    ...
    //Inserting into tblassets_inventory and tbllogs 
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Add Asset to Employee</h6>
                        </div>
                        <div class="card-body">
...
document.getElementById("branchName").addEventListener("change", function() {
    ...
    if (selectedOption.value !== "") {
        // Fill Branch Code input field
        var branchCode = selectedOption.getAttribute("data-branchCode");
